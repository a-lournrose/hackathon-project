...
export const CategoryItem = (props: ICategoryItemProps) => {
  ...
  return (
    <div
      onClick={handleClick}
      className={cn(
        'cursor-default transition-all rounded-lg bg-light-2 p-3 md:p-6 flex flex-col items-center justify-between gap-1 md:gap-2 border-2 border-light-2 hover:border-primary-500 min-w-[150px]',
